(function (global, factory) {
  ...
  var queueMicrotask = typeof queueMicrotask === 'undefined' ? setTimeout : queueMicrotask;
  ...
  PromisePolyfill.prototype.then = function (onFulfilled, onRejected) {
    ...
    if (ctx.status === FULFILLED) {
      var _promise = new PromisePolyfill(function (resolve, reject) {
        queueMicrotask(function () {
          try {
    ...
    if (ctx.status === REJECTED) {
      var _promise2 = new PromisePolyfill(function (resolve, reject) {
        queueMicrotask(function () {
          try {
  ...
  var PROMISE = typeof Promise === 'undefined' ? PromisePolyfill : Promise;
